...
- **Model 1:** First model is the basic model built and is overfitting. 
- **Model 2:** Second model is showing the signs of underfitting because if less data. 
